!==================================================================================================
! This module is stubbed from ${E3SM_ROOT}/share/nuopc/seq_drydep_mod.F90
! 
! Procedures and data: ESMF_VMGetCurrent, ESMF_VMGet, ESMF_LogFoundError, ESMF_LOGERR_PASSTHRU
! from the ESMF module appears to be deprecated and is not set anywhere within the present version
! of E3SM. These have been removed in this refactor with no replacement. ESMF is a timing
! library so this is likely safe, however some information may be lost.
!
...
module seq_drydep_mod
  ...
  use ESMF           , only: ESMF_VM, ESMF_SUCCESS
