!==================================================================================================
! The 'modal_aero_data' module has been stubbed to remove procedures with depedendencies 
! incompatible with EAMxx such as the time_manager and physics buffer
!
