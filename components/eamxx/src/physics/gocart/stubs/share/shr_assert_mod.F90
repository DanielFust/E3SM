...
subroutine print_bad_loc_0d_real(var, loc_vec, varname)
  ...
  write(shr_log_Unit,*) &
       ...
       " has invalid value ", &
#if (0 != 0)
       var(loc_vec(1)),       " at location: ",loc_vec
#else
       var
...
subroutine print_bad_loc_2d_real(var, loc_vec, varname)
  ...
  write(shr_log_Unit,*) &
       ...
       " has invalid value ", &
#if (2 != 0)
       var(loc_vec(1),loc_vec(2)),       " at location: ",loc_vec
#else
       var
...
subroutine print_bad_loc_3d_real(var, loc_vec, varname)
  ...
  write(shr_log_Unit,*) &
       ...
       " has invalid value ", &
#if (3 != 0)
       var(loc_vec(1),loc_vec(2),loc_vec(3)),       " at location: ",loc_vec
#else
       var
...
subroutine print_bad_loc_4d_real(var, loc_vec, varname)
  ...
  write(shr_log_Unit,*) &
       ...
       " has invalid value ", &
#if (4 != 0)
       var(loc_vec(1),loc_vec(2),loc_vec(3),loc_vec(4)),       " at location: ",loc_vec
#else
       var
...
subroutine print_bad_loc_5d_real(var, loc_vec, varname)
  ...
  write(shr_log_Unit,*) &
       ...
       " has invalid value ", &
#if (5 != 0)
       var(loc_vec(1),loc_vec(2),loc_vec(3),loc_vec(4),loc_vec(5)),       " at location: ",loc_vec
#else
       var
...
subroutine print_bad_loc_6d_real(var, loc_vec, varname)
  ...
  write(shr_log_Unit,*) &
       ...
       " has invalid value ", &
#if (6 != 0)
       var(loc_vec(1),loc_vec(2),loc_vec(3),loc_vec(4),loc_vec(5),loc_vec(6)),       " at location: ",loc_vec
#else
       var
...
subroutine print_bad_loc_7d_real(var, loc_vec, varname)
  ...
  write(shr_log_Unit,*) &
       ...
       " has invalid value ", &
#if (7 != 0)
       var(loc_vec(1),loc_vec(2),loc_vec(3),loc_vec(4),loc_vec(5),loc_vec(6),loc_vec(7)),       " at location: ",loc_vec
#else
       var
...
#if (2 != 0)
  integer :: flags(size(mask,1), size(mask,2))
...
#if (3 != 0)
  integer :: flags(size(mask,1), size(mask,2), size(mask,3))
...
#if (4 != 0)
  integer :: flags(size(mask,1), size(mask,2), size(mask,3), size(mask,4))
...
#if (5 != 0)
  integer :: flags(size(mask,1), size(mask,2), size(mask,3), size(mask,4), size(mask,5))
...
#if (6 != 0)
  integer :: flags(size(mask,1), size(mask,2), size(mask,3), size(mask,4), size(mask,5), size(mask,6))
...
#if (7 != 0)
  integer :: flags(size(mask,1), size(mask,2), size(mask,3), size(mask,4), size(mask,5), size(mask,6), size(mask,7))
