!------------------------------------------------------------------------------
! This copy of 'shr_string_mod' exists separate from the E3SM/share version
! in order to specify the "shr_assert.h" header which may not otherwise be
! in the file path during compilation of this translation unit
!
