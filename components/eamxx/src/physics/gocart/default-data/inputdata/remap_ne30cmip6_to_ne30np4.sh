MAP_FILE="/global/homes/f/fust1/maps/map_ne30cmip6_to_ne30np4_nco.c20250808.nc"
...
REMAPPED_DATA_DIR="/global/u1/f/fust1/inputdata/ne30np4"
...
MAP_FILE="/global/homes/f/fust1/maps/map_180x360_to_ne30np4_nco.c20250808.nc"
if [ -f "${REMAPPED_DATA_DIR}/${FILE}" ]; then
    echo "${FILE} has already been remapped..."
else
    #echo "ncremap -m ${MAP_FILE} -i ${DATA_DIR}/${FILE} -o ${REMAPPED_DATA_DIR}/${FILE}"
